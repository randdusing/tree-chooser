...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(3)(treeChooser);
	__webpack_require__(13)(treeChooser);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (treeChooser) {
	  treeChooser.directive('treeChooser', __webpack_require__(4)).controller('treeChooserController', __webpack_require__(10));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!./treeChooser.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!./treeChooser.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (treeChooser) {
	  treeChooser.directive('treeChooserItem', __webpack_require__(14)).controller('treeChooserItemController', __webpack_require__(16)).factory('TreeChooserItem', __webpack_require__(17));
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<span class=\"treeChooser-item\"\n      ng-class=\"{'treeChooser-selected': vm.item.isSelected(), 'treeChooser-active': vm.item.isActive()}\">\n  <!-- Expansion -->\n  <span class=\"treeChooser-expansion\"\n        ng-click=\"vm.item.setActive(true); vm.item.toggleExpanded()\">\n    <span ng-show=\"vm.item.hasAChildPresent() && vm.item.isExpanded()\"\n          class=\"treeChooser-expanded\">-</span>\n    <span ng-show=\"vm.item.hasAChildPresent() && !vm.item.isExpanded()\"\n          class=\"treeChooser-collapsed\">+</span>\n  </span>\n\n  <!-- Label @todo turn into template -->\n  <span class=\"treeChooser-label\"\n        ng-class=\"{'treeChooser-disabled': vm.chooserVm.disableNode(vm.item)}\"\n        ng-click=\"vm.item.setActive(true); vm.chooserVm.toggleSelected(vm.item)\">\n    {{vm.item.getLabel()}}\n  </span>\n\n  <!-- Recursion -->\n  <ul ng-if=\"vm.item.isExpanded()\">\n    <li ng-repeat=\"item in vm.item.getPresentChildren()\"\n        tree-chooser-item=\"item\"></li>\n  </ul>\n</span>\n";
